...
from app.schemas.schema import CollectionCreate, CollectionUpdate
...
def get_collections(
    ...
    return collection_services.get_all_collections(
        db=db)
...
def get_one_collection(collection_id: int,
    ...
    return collection_services.get_collection_by_id(
        db=db, 
...
def create_collections(collection: CollectionCreate,
    ...
    # Pass the database session and data to the service layer
    return collection_services.create_collection(db=db, collection=collection, user_id=current_user["id"])
...
def update_collection(collection_id: int,
    ...
    return collection_services.update_collection(
        db=db,
        collection_id=collection_id,
...
def delete_collection(collection_id: int,
    ...
    return collection_services.delete_collection(
        db=db,
        collection_id=collection_id
    )
